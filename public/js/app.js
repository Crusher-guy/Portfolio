...
contactForm.addEventListener('submit', (e) => {
  ...
  xhr.setRequestHeader('content-type', 'application/JSON'); // application/json é a melhor forma de converter os dados e enviar, considerando que os dados capturados foi inseridos no objeto acima.
  xhr.onload = function () {
    console.log(xhr.responseText);
    if(xhr.responseText == 'Email enviado com sucesso!') {
      ...
      alert(
        'Algo não saiu como esperado e seu e-mail não foi enviado. Se preferir faça contato pelo número whatsapp disponível na página'
      );
    }
  };
